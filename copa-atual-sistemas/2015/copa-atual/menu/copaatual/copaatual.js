...
/*!
 * JavaScript code for drop-down menu (created: August 03, 2015)
...
CssFn+='src:url(\''+Path+'MG_Icons.eot\');';
        ...
        CssFn+='    url(\''+Path+'MG_Icons.woff?#229786169\') format(\'woff\'),';
        CssFn+='    url(\''+Path+'MG_Icons.ttf?#229786169\') format(\'truetype\');';
...
function AddCss_copaatual(Path){
    var stls=document.getElementsByTagName('style');
    var Hd=document.getElementsByTagName('head')[0];
    for (var i=0;i<stls.length;i++){   
        if(stls[i]!=null&&stls[i]!=undefined){                            
            var stid=stls[i].getAttribute('id');   
            if(stid!=null&&stid!=undefined){
                if(stid=='Style_Menu_copaatual'){
                    Hd.removeChild(stls[i]);
                }
            }
        }
    }
    var Css='.mn999AMainMenuDIV TD, .mn999ASubMenuDIV TD {vertical-align: middle;border: none;padding: 0px;}.mn999ADefaults {color: #3D804D;OverlapVertical: 1px;OverlapHorizontal: 5px;}.mn999AIconTD, .mn999ATitleTD, .mn999AArrowTD {text-shadow: none;font-size: 12px;font-family: Arial;white-space: nowrap;padding: 0px;line-height: normal;vertical-align: middle;}.mn999ATitleTD {text-align: left;}.mn999AIconTD font, .mn999AArrowTD font {margin: 0 !important;display: block !important;padding: 0px;line-height: 12px;}.mn999AMainMenuDIV {padding: 4px;background-color: #DFDDD2;cursor: default;background: transparent;}.mn999AMainMenuDIV TABLE {border-collapse: separate;margin: 0px;padding: 0px;}.mn999AMenu_Width {}.mn999AMainMenuItemTD {padding: 6px !important;}.mn999AMainMenuItemTD .mn999ATitleTD, .mn999AMainMenuItemTD .mn999AIconTD, .mn999AMainMenuItemTD .mn999AArrowTD {color: #000000;}.mn999AMainMenuItemHoveredTD {padding: 6px !important;background-color: #3D804D;cursor: default;cursor: hand;cursor: pointer;}.mn999AMainMenuItemHoveredTD .mn999ATitleTD, .mn999AMainMenuItemHoveredTD .mn999AIconTD, .mn999AMainMenuItemHoveredTD .mn999AArrowTD {color: #FFFFFF;}.mn999AMainMenuItemSelectedTD {padding: 6px !important;background-color: #C2BEAA;}.mn999AMainMenuItemSelectedTD .mn999ATitleTD, .mn999AMainMenuItemSelectedTD .mn999AIconTD, .mn999AMainMenuItemSelectedTD .mn999AArrowTD {color: #000000;}.mn999ASubMenuDIV {-moz-box-sizing: content-box;-webkit-box-sizing: content-box;box-sizing: content-box;padding: 4px;background-color: #DFDDD3;cursor: default;}.mn999ASubMenuDIV TABLE {border-collapse: separate;width: auto !important;margin: 0px;padding: 0px;}.mn999ASubMenuItemTD, .mn999ASubResDIV {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;}.mn999ASubMenuItemTD .mn999ATitleTD, .mn999ASubMenuItemTD .mn999AIconTD, .mn999ASubMenuItemTD .mn999AArrowTD, .mn999ASubResDIV {color: #656565;}.mn999ASubMenuItemHoveredTD, .mn999ASubResDIV:hover {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;background-color: #3D804D;cursor: default;cursor: hand;cursor: pointer;}.mn999ASubMenuItemHoveredTD .mn999ATitleTD, .mn999ASubMenuItemHoveredTD .mn999AIconTD, .mn999ASubMenuItemHoveredTD .mn999AArrowTD, .mn999ASubResDIV:hover {color: #FFFFFF;}.mn999ASubMenuItemSelectedTD {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;background-color: #C2BEAA;}.mn999ASubMenuItemSelectedTD .mn999ATitleTD, .mn999ASubMenuItemSelectedTD .mn999AIconTD, .mn999ASubMenuItemSelectedTD .mn999AArrowTD {color: #656565;}.mn999ASeparatorVerticalTD {padding: 0px !important;border-left-style: solid !important;border-left-width: 1px !important;border-left-color: #C2BEAA !important;}.mn999ASeparatorHorizontalTD {padding: 0px !important;border-top-style: solid !important;border-top-width: 1px !important;border-top-color: #C2BEAA !important;}.mn999ATooltipDIV {font-family: Arial;font-size: 12px;color: #555555;padding: 3px;padding-left: 5px;padding-right: 5px;background-color: #F8F8F8;border: solid 1px #888888;border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;-moz-border-radius: 3px;}.mn999AIconTD {color: #010100;vertical-align: middle;text-align: center;}.mn999AIconTD font {font-size: 16px;padding-left: 2px;padding-right: 8px;width: 16px;}';

    var stl=document.createElement('style');
    stl.setAttribute('type','text/css');
    stl.setAttribute('id', 'Style_Menu_copaatual');
    if(stl.styleSheet==null||stl.styleSheet==undefined){
        try{
            stl.innerHTML=Css;
        }catch(err){
...
var gbd4Hirq0nTydcopaatual='mnF0C41BA7';
var mnF0C41BA7i=function(){dm.i('mnF0C41BA7',0);};
var mnF0C41BA7L = null;
function mnF0C41BA7LCn(Path){
this.id='copaatual';
this.uid='copaatual';
this.sfu=Path;
this.qstr='';
...
this.SelIts=null;
this.SMH='10000px';
this.nids='<ii1/><ii2/><ii9/><ii12/><ii7/><ii5/><ii6/>';
this.SbmAtHd=true;
};
...
var copaatual={
    ...
    Prepare:function(){
        ...
        AddCss_copaatual(Path);
mnF0C41BA7L=new mnF0C41BA7LCn(Path);copaatual.Mnu='<div><input id="sit_mnF0C41BA7_vs" name="sit_mnF0C41BA7_vs" type="hidden" value="" /></div><div id="mnF0C41BA7_-0p" class="mn999AMainMenuDIV" onmouseover="dm.vD();" onmouseout="dm.uD();" style="z-index:10000;position:static;vertical-align:top;display:-moz-inline-stack;display:inline-block;zoom:1;*display:inline;"><table border="0" cellspacing="0" cellpadding="0" onclick="dm.mc();"><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnF0C41BA7_i1" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/copa-atual/principal.html\',\'principal\');" class="mn999AMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn999AIconTD"><font class="MG_Icons">&#xe721;</font></td><td class="mn999ATitleTD" id="mnF0C41BA7_i1-tl">Início</td><td class="mn999AArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnF0C41BA7_i2" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/copa-atual/regulamento.html\',\'principal\');" class="mn999AMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn999AIconTD"><font class="MG_Icons">&#xe74b;</font></td><td class="mn999ATitleTD" id="mnF0C41BA7_i2-tl">Regulamento</td><td class="mn999AArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnF0C41BA7_i9" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/copa-atual/calendario.html\',\'principal\');" class="mn999AMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn999AIconTD"><font class="MG_Icons">&#xe744;</font></td><td class="mn999ATitleTD" id="mnF0C41BA7_i9-tl">Calendário</td><td class="mn999AArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnF0C41BA7_i12" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/copa-atual/times.html\',\'principal\');" class="mn999AMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn999AIconTD"><font class="MG_Icons">&#xe73f;</font></td><td class="mn999ATitleTD" id="mnF0C41BA7_i12-tl">Times</td><td class="mn999AArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnF0C41BA7_i7" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/copa-atual/confrontos.html\',\'principal\');" class="mn999AMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn999AIconTD"><font class="MG_Icons">&#xe76d;</font></td><td class="mn999ATitleTD" id="mnF0C41BA7_i7-tl">Resultados</td><td class="mn999AArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnF0C41BA7_i5" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/fotos/index.html\',\'_top\');" class="mn999AMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn999AIconTD"><font class="MG_Icons">&#xe757;</font></td><td class="mn999ATitleTD" id="mnF0C41BA7_i5-tl">Fotos</td><td class="mn999AArrowTD">&nbsp;</td></tr></table></td><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mnF0C41BA7_i6" onclick="dm.ItClk(this,\'\');" class="mn999AMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn999AIconTD"><font class="MG_Icons">&#xe732;</font></td><td class="mn999ATitleTD" id="mnF0C41BA7_i6-tl">Inscrição</td><td class="mn999AArrowTD">&nbsp;</td></tr></table></td></tr></table></div>';copaatual.SubMnu='<div id="mnF0C41BA7ifc"></div>';
    },
    ...
    GetDst:function(){
        var DstID=copaatual._div;
        if(DstID=='')DstID='copaatual';
        var Dst=cmn.Mko(DstID);
        return Dst;
    },

    PlaceAuto:function(p,d,sb){
        copaatual.Plcd=false;
        copaatual._path='';
        copaatual._div='';
        copaatual._SbMnu=false;
        if(p!=null&&p!=undefined&&p!=''){copaatual._path=p;}
        if(d!=null&&d!=undefined&&d!=''){copaatual._div=d;}
        if(sb==true){copaatual._SbMnu=true;}
        copaatual.Prepare();
        copaatual.addEvent(window,'load',copaatual.PutInDIV);
        copaatual.PutInDIV_TO(0);
    },

    PutInDIV_TO:function(t){
        var Dst=copaatual.GetDst();
        if(Dst==null||Dst==undefined){
            if(t<50){
                t++;
                setTimeout('copaatual.PutInDIV_TO('+t+');',50);
                return;
            }
        }else{
            copaatual.PutInDIV();
    ...
    PutInDIV:function(){
        if(copaatual.Plcd==true)return;
        var Dst=copaatual.GetDst();
        if(Dst==null||Dst==undefined){
            return;
        }

        if(copaatual._SbMnu==true){
            Dst.innerHTML=copaatual.Mnu+copaatual.SubMnu;
        }else{
            Dst.innerHTML=copaatual.Mnu;
            var Dv=document.createElement('DIV');
            Dv.innerHTML=copaatual.SubMnu;
            document.body.appendChild(Dv);
        }

        setTimeout('mnF0C41BA7i()',10);
        copaatual.Plcd=true;
        var Mnu=cmn.Mko('mnF0C41BA7_-0p');
        if(Mnu!=null){
            var ShMn=function(){
    ...
    Show:function(){
        copaatual.Plcd=false;
        copaatual.Prepare();
        document.write(copaatual.Mnucopaatual.SubMnu);
        setTimeout('mnF0C41BA7i()',10);
        copaatual.Plcd=true;
    }
