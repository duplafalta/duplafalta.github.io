  ...
  function nanoGALLERY() {
    ...
    */
    this.ReloadAlbum = function(){
      if( G.O.kind === '' ) {
        throw 'Não suportado por este tipo.';
      }
      ...
      if( albumIdx == -1 ) {
        throw ('Álbum atual não encontrado.');
      }
    ...
    */
    ...
    this.GetItem = function(index){
      if(isNaN(index)){
        throw 'índice deve ser um número';
      }
      return G.I[index];
    };
    ...
    G.i18nTranslations = {'paginationPrevious':'Anterior', 'paginationNext':'Próxima', 'breadcrumbHome':'Lista de Álbuns', 'thumbnailImageTitle':'', 'thumbnailAlbumTitle':'', 'thumbnailImageDescription':'', 'thumbnailAlbumDescription':'' }
    ...
    */
    ...
    this.Initiate = function( element, params ) {
      ...
      if( document.fullscreenEnabled || document.webkitFullscreenEnabled || document.msFullscreenEnabled || document.mozFullScreenEnabled) {
        ...
        nanoConsoleLog('Seu navegador não suporta a API de tela inteira. O botão de tela cheia não será exibido.');
      }
    ...
    function BrowserNotification() {
      var m='A versão do seu navegador não é mais suportada. A galeria de imagens não pode ser exibida. <br><br>Por favor, atualize para um mais recente. Download:<br>';
        ...
        case '':
          ...
          if( G.O.items !== undefined && G.O.items !== null ) {
            ...
            if( elements.length > 0 ) {
              ...
              nanoAlert('erro: nenhuma imagem para processar.');
          }
          break;
    ...
    function checkPluginParameters() {
      ...
      if( G.O.viewer == 'fancybox' ) {
        if( typeof(jQuery.fancybox) === 'undefined' ) {
          G.O.viewer = 'internal';
          nanoConsoleLog('O Fancybox não foi encontrado. Retorno ao visualizador interno. Por favor, verifique os arquivos incluídos na página HTML.');
        }
      }
