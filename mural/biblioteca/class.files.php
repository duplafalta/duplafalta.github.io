...
class files
{
    ...
    */
    function get_file_list($directory, $type = "img_creation", $print_list = false)
    {
        ...
        if(!is_dir($directory))
        {
            $this->_error("Diretório Inválido: " . $diretorio, E_USER_ERROR);
        }
        ...
        {
            $this->_error("Impossível abrir o diretório: " . $directory, E_USER_ERROR);
        }
        ...
        if(!sizeof($file_list))
        {
            $this->_error("O diretório: " . $directory . " está vazio!", E_USER_NOTICE);
        }
