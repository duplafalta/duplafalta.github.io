...
/*!
 * JavaScript code for drop-down menu (created: August 05, 2015)
...
CssFn+='src:url(\''+Path+'MG_Icons.eot\');';
        ...
        CssFn+='    url(\''+Path+'MG_Icons.woff?#676398617\') format(\'woff\'),';
        CssFn+='    url(\''+Path+'MG_Icons.ttf?#676398617\') format(\'truetype\');';
...
function AddCss_kisuco(Path){
    ...
    for (var i=0;i<stls.length;i++){   
        if(stls[i]!=null&&stls[i]!=undefined){                            
            var stid=stls[i].getAttribute('id');   
            if(stid!=null&&stid!=undefined){
                if(stid=='Style_Menu_kisuco'){
                    Hd.removeChild(stls[i]);
                }
            }
        }
    }
    var Css='.mn4FBMainMenuDIV TD, .mn4FBSubMenuDIV TD {vertical-align: middle;border: none;padding: 0px;}.mn4FBDefaults {color: #007771;OverlapVertical: 1px;OverlapHorizontal: 5px;}.mn4FBIconTD, .mn4FBTitleTD, .mn4FBArrowTD {text-shadow: none;font-size: 14px;font-family: Arial;white-space: nowrap;padding: 0px;line-height: normal;vertical-align: middle;}.mn4FBTitleTD {text-align: left;}.mn4FBIconTD font, .mn4FBArrowTD font {margin: 0 !important;display: block !important;padding: 0px;line-height: 14px;}.mn4FBMainMenuDIV {padding: 4px;background-color: #DFDDD2;cursor: default;background: transparent;}.mn4FBMainMenuDIV TABLE {border-collapse: separate;margin: 0px;padding: 0px;}.mn4FBMenu_Width {}.mn4FBMainMenuItemTD {padding: 6px !important;}.mn4FBMainMenuItemTD .mn4FBTitleTD, .mn4FBMainMenuItemTD .mn4FBIconTD, .mn4FBMainMenuItemTD .mn4FBArrowTD {color: #000000;}.mn4FBMainMenuItemHoveredTD {padding: 6px !important;background-color: #007771;cursor: default;cursor: hand;cursor: pointer;}.mn4FBMainMenuItemHoveredTD .mn4FBTitleTD, .mn4FBMainMenuItemHoveredTD .mn4FBIconTD, .mn4FBMainMenuItemHoveredTD .mn4FBArrowTD {color: #FFFFFF;}.mn4FBMainMenuItemSelectedTD {padding: 6px !important;background-color: #C2BEAA;}.mn4FBMainMenuItemSelectedTD .mn4FBTitleTD, .mn4FBMainMenuItemSelectedTD .mn4FBIconTD, .mn4FBMainMenuItemSelectedTD .mn4FBArrowTD {color: #000000;}.mn4FBSubMenuDIV {-moz-box-sizing: content-box;-webkit-box-sizing: content-box;box-sizing: content-box;padding: 4px;background-color: #DFDDD3;cursor: default;}.mn4FBSubMenuDIV TABLE {border-collapse: separate;width: auto !important;margin: 0px;padding: 0px;}.mn4FBSubMenuItemTD, .mn4FBSubResDIV {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;}.mn4FBSubMenuItemTD .mn4FBTitleTD, .mn4FBSubMenuItemTD .mn4FBIconTD, .mn4FBSubMenuItemTD .mn4FBArrowTD, .mn4FBSubResDIV {color: #000000;}.mn4FBSubMenuItemHoveredTD, .mn4FBSubResDIV:hover {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;background-color: #007771;cursor: default;cursor: hand;cursor: pointer;}.mn4FBSubMenuItemHoveredTD .mn4FBTitleTD, .mn4FBSubMenuItemHoveredTD .mn4FBIconTD, .mn4FBSubMenuItemHoveredTD .mn4FBArrowTD, .mn4FBSubResDIV:hover {color: #FFFFFF;}.mn4FBSubMenuItemSelectedTD {padding: 6px !important;padding-left: 7px !important;padding-right: 7px !important;background-color: #C2BEAA;}.mn4FBSubMenuItemSelectedTD .mn4FBTitleTD, .mn4FBSubMenuItemSelectedTD .mn4FBIconTD, .mn4FBSubMenuItemSelectedTD .mn4FBArrowTD {color: #000000;}.mn4FBSeparatorVerticalTD {padding: 0px !important;border-left-style: solid !important;border-left-width: 1px !important;border-left-color: #C2BEAA !important;}.mn4FBSeparatorHorizontalTD {padding: 0px !important;border-top-style: solid !important;border-top-width: 1px !important;border-top-color: #C2BEAA !important;}.mn4FBTooltipDIV {font-family: Arial;font-size: 12px;color: #555555;padding: 3px;padding-left: 5px;padding-right: 5px;background-color: #F8F8F8;border: solid 1px #888888;border-radius: 3px;-webkit-border-radius: 3px;-khtml-border-radius: 3px;-moz-border-radius: 3px;}.mn4FBIconTD {color: #010100;vertical-align: middle;text-align: center;}.mn4FBIconTD font {font-size: 16px;padding-left: 2px;padding-right: 8px;width: 16px;}';

    var stl=document.createElement('style');
    stl.setAttribute('type','text/css');
    stl.setAttribute('id', 'Style_Menu_kisuco');
    if(stl.styleSheet==null||stl.styleSheet==undefined){
        try{
            stl.innerHTML=Css;
        }catch(err){
...
var gbd4Hirq0nTydkisuco='mn1149EF44';
var mn1149EF44i=function(){dm.i('mn1149EF44',0);};
var mn1149EF44L = null;
function mn1149EF44LCn(Path){
this.id='kisuco';
this.uid='kisuco';
this.sfu=Path;
this.qstr='';
...
this.SelIts=null;
this.SMH='10000px';
this.nids='<ii1/><ii2/><ii9/><ii12/><ii5/><ii6/>';
this.SbmAtHd=true;
this.ttt_mn1149EF44_i1='Go to Home Page';
};
...
var kisuco={
    ...
    Prepare:function(){
        ...
        AddCss_kisuco(Path);
mn1149EF44L=new mn1149EF44LCn(Path);kisuco.Mnu='<div><input id="sit_mn1149EF44_vs" name="sit_mn1149EF44_vs" type="hidden" value="" /></div><div id="mn1149EF44_-0p" class="mn4FBMainMenuDIV" onmouseover="dm.vD();" onmouseout="dm.uD();" style="visibility:hidden;z-index:10000;position:static;vertical-align:top;display:-moz-inline-stack;display:inline-block;zoom:1;*display:inline;"><table border="0" cellspacing="0" cellpadding="0" onclick="dm.mc();"><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mn1149EF44_i1" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/kisuco/index.html\',\'_top\');" class="mn4FBMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn4FBIconTD"><font class="MG_Icons">&#xe721;</font></td><td class="mn4FBTitleTD" id="mn1149EF44_i1-tl">Principal</td><td class="mn4FBArrowTD">&nbsp;</td></tr></table></td></tr><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mn1149EF44_i2" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/kisuco/sobre.html\',\'_top\');" class="mn4FBMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn4FBIconTD"><font class="MG_Icons">&#xe728;</font></td><td class="mn4FBTitleTD" id="mn1149EF44_i2-tl">Sobre o Projeto</td><td class="mn4FBArrowTD">&nbsp;</td></tr></table></td></tr><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mn1149EF44_i9" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/kisuco/fotos/index.html\',\'_top\');" class="mn4FBMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn4FBIconTD"><font class="MG_Icons">&#xe757;</font></td><td class="mn4FBTitleTD" id="mn1149EF44_i9-tl">Fotos</td><td class="mn4FBArrowTD">&nbsp;</td></tr></table></td></tr><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mn1149EF44_i12" onclick="dm.ItClk(this,\'\');cmn.href(\'http://jogosonline.uol.com.br/tenis.html#rmcl\',\'_top\');" class="mn4FBMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn4FBIconTD"><font class="MG_Icons">&#xe723;</font></td><td class="mn4FBTitleTD" id="mn1149EF44_i12-tl">Jogos</td><td class="mn4FBArrowTD">&nbsp;</td></tr></table></td></tr><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mn1149EF44_i5" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/kisuco/apoie.html\',\'_top\');" class="mn4FBMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn4FBIconTD"><font class="MG_Icons">&#xe775;</font></td><td class="mn4FBTitleTD" id="mn1149EF44_i5-tl">Apoie o Projeto</td><td class="mn4FBArrowTD">&nbsp;</td></tr></table></td></tr><tr><td onmouseover="dm.v(this,1);" onmouseout="dm.u(this);" id="mn1149EF44_i6" onclick="dm.ItClk(this,\'\');cmn.href(\'http://duplafalta.com.br/kisuco/contato/index.html\',\'_top\');" class="mn4FBMainMenuItemTD"><table border="0" cellspacing="0" cellpadding="0"><tr><td class="mn4FBIconTD"><font class="MG_Icons">&#xe724;</font></td><td class="mn4FBTitleTD" id="mn1149EF44_i6-tl">Contato</td><td class="mn4FBArrowTD">&nbsp;</td></tr></table></td></tr></table></div>';kisuco.SubMnu='<div id="mn1149EF44ifc"></div>';
    },
    ...
    GetDst:function(){
        var DstID=kisuco._div;
        if(DstID=='')DstID='kisuco';
    ...
    PlaceAuto:function(p,d,sb){
        ...
        kisuco._div='';
        kisuco._SbMnu=false;
        if(p!=null&&p!=undefined&&p!=''){kisuco._path=p;}
        if(d!=null&&d!=undefined&&d!=''){kisuco._div=d;}
        if(sb==true){kisuco._SbMnu=true;}
        kisuco.Prepare();
        kisuco.addEvent(window,'load',kisuco.PutInDIV);
        kisuco.PutInDIV_TO(0);
    },

    PutInDIV_TO:function(t){
        var Dst=kisuco.GetDst();
        if(Dst==null||Dst==undefined){
            if(t<50){
                t++;
                setTimeout('kisuco.PutInDIV_TO('+t+');',50);
                return;
            }
        }else{
            kisuco.PutInDIV();
    ...
    PutInDIV:function(){
        if(kisuco.Plcd==true)return;
        var Dst=kisuco.GetDst();
        if(Dst==null||Dst==undefined){
            return;
        }

        if(kisuco._SbMnu==true){
            Dst.innerHTML=kisuco.Mnu+kisuco.SubMnu;
        }else{
            Dst.innerHTML=kisuco.Mnu;
            var Dv=document.createElement('DIV');
            Dv.innerHTML=kisuco.SubMnu;
            document.body.appendChild(Dv);
        }

        setTimeout('mn1149EF44i()',10);
        kisuco.Plcd=true;
        var Mnu=cmn.Mko('mn1149EF44_-0p');
        if(Mnu!=null){
            var ShMn=function(){
    ...
    Show:function(){
        kisuco.Plcd=false;
        kisuco.Prepare();
        document.write(kisuco.Mnukisuco.SubMnu);
        setTimeout('mn1149EF44i()',10);
        kisuco.Plcd=true;
    }
